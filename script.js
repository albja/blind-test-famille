...
const quizData = {
  "Disney 🇫🇷": [
    ...
    { title: "Sous l'océan", artist: "Disney" },
    { title: "Il en faut peu pour être heureux", artist: "Disney" },
    { title: "Je voudrais déjà être roi", artist: "Disney" },
    { title: "L'air du vent", artist: "Disney" },
    { title: "Partir là-bas", artist: "Disney" },
    { title: "Un jour mon prince viendra", artist: "Disney" },
    { title: "L'histoire de la vie", artist: "Disney" },
    { title: "Belle", artist: "Disney" },
    { title: "Gaston", artist: "Disney" },
    { title: "Un ami en moi", artist: "Disney" },
    { title: "Je veux y croire", artist: "Disney" },
    { title: "Le festin", artist: "Camille" },
    { title: "Pour la première fois", artist: "Anaïs Delva" },
    { title: "Je ne savais pas", artist: "Anaïs Delva" },
    { title: "Le bleu lumière", artist: "Anaïs Delva" },
    { title: "Comme un homme", artist: "Disney" },
    { title: "Reflet", artist: "Disney" },
    { title: "Au bout du rêve", artist: "Disney" },
    { title: "Prince Ali", artist: "Disney" },
    { title: "Tout le monde veut devenir un cat", artist: "Disney" },
    { title: "L'amour brille sous les étoiles", artist: "Disney" },
    { title: "Soyez prêts", artist: "Disney" },
    { title: "Je voudrais", artist: "Disney" },
    { title: "C'est la fête", artist: "Disney" },
    { title: "Pauvre âme en perdition", artist: "Disney" },
    { title: "Sauvages", artist: "Disney" },
    { title: "Cruella d'enfer", artist: "Disney" },
    ...
    { title: "Vivre", artist: "Notre-Dame de Paris" },
    { title: "Les oiseaux du bonheur", artist: "Disney" },
    { title: "Rêve bleu", artist: "Disney" },
    { title: "Un monde nouveau", artist: "Disney" },
    { title: "Loin de tout", artist: "Cerise Calil" },
    { title: "Notre terre", artist: "Cerise Calil" },
    { title: "Avez-vous déjà vu", artist: "Disney" },
    { title: "Les cloches de Notre-Dame", artist: "Disney" },
    { title: "Supercalifragilisticexpialidocious", artist: "Disney" },
    { title: "Bibbidi-Bobbidi-Boo", artist: "Disney" },
    { title: "Quand on prie la bonne étoile", artist: "Disney" },
    { title: "Toujours là pour moi", artist: "Disney" },
    { title: "Un beau jour", artist: "Disney" },
    { title: "Je suis ton ami", artist: "Disney" },
    { title: "N'oublie pas", artist: "Disney" },
    { title: "Digga Tunnah", artist: "Disney" },
    { title: "Ma vraie place", artist: "Disney" }
  ],
  Pop: [
  ...
  "Variété Française": [
    ...
    { title: "Mourir d'aimer", artist: "Charles Aznavour" },
    { title: "Mistral gagnant", artist: "Renaud" },
    { title: "Hexagone", artist: "Renaud" },
    ...
    { title: "C'est extra", artist: "Léo Ferré" },
    ...
    { title: "Mon amant de Saint-Jean", artist: "Patrick Bruel" }
  ],
  "Années 80 France": [
