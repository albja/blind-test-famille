...
const quizData = {
  "Disney 🇫🇷": [
    ...
    { title: "Ce rêve bleu", artist: "Paolo Domingo" },
    ...
    { title: "L' air Du Vent", artist: "Laura Mayne" },
    ...
    { title: "Histoire éternelle", artist: "Lucie Dolène" },
    { title: "Heigh-Ho!", artist: "Jean-Claude Donda" },
    { title: "Pour les hommes", artist: "Anthony Kavanagh" },
    { title: "J'ai un rêve", artist: "Emmanuel Dahl" },
    { title: "Je veux savoir", artist: "Phil Collins" },
    { title: "Les cloches de Notre-Dame", artist: "Le Bossu de Notre-Dame" },
    { title: "Ton meilleur ami", artist: "Aladdin" },
    { title: "Soyez prêtes", artist: "Jean Piat" },
    { title: "Je suis ton ami", artist: "Toy Story" },
    { title: "Là-haut", artist: "Michael Giacchino" },
    { title: "Il en faut peu pour être heureux", artist: "Patrick Bressy" },
    { title: "Sous les apparences", artist: "Ana Ka" },
    { title: "Je fais le voeu", artist: "Océane Demontis" },
    { title: "Quand on prie la bonne étoile", artist: "Pinocchio" },
    { title: "Toujours là pour moi", artist: "Tarzan" },
    { title: "Des sauvages", artist: "Patrick Rocca" },
    { title: "Un beau jour", artist: "Winnie l'ourson" },
    { title: "De Zéro en Héros", artist: "Mimi Félixine" },
