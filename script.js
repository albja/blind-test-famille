...
const quizData = {
  "Disney 🇫🇷": [
    ...
    { title: "Sous l'océan", artist: "Samuel Le Bihan" },
    ...
    { title: "Je ne savais pas", artist: "La Reine des Neiges 2" },
    { title: "Loin de tout", artist: "Vaiana" },
    { title: "Notre terre", artist: "Vaiana" },
    { title: "Avez-vous déjà vu", artist: "Le Bossu de Notre-Dame" },
    { title: "Les cloches de Notre-Dame", artist: "Le Bossu de Notre-Dame" },
    { title: "Sauver ou périr", artist: "Hercule" },
    { title: "Comme un homme", artist: "Mulan" },
    { title: "Reflet", artist: "Mulan" },
    { title: "Je suis ton ami", artist: "Toy Story" },
    { title: "Au bout du rêve", artist: "Raiponce" },
    { title: "Ma vraie place", artist: "Raiponce" },
    { title: "Rêve bleu", artist: "Aladdin" },
    { title: "Prince Ali", artist: "Aladdin" },
    { title: "Tout le monde veut devenir un cat", artist: "Les Aristochats" },
    { title: "Les poissons", artist: "La Petite Sirène" },
    { title: "Pauvre âme en perdition", artist: "La Petite Sirène" },
    { title: "Sauvages", artist: "Pocahontas" },
    { title: "Un monde nouveau", artist: "Aladdin" },
    ...
    { title: "Vivre ici", artist: "La Belle et la Bête" },
    { title: "Laissons entrer le soleil", artist: "Coco" },
    { title: "N'oublie pas", artist: "Coco" },
    { title: "Un beau jour", artist: "Le Roi Lion 2" },
    { title: "C'est la fête", artist: "La Belle et la Bête" },
    { title: "Le monde de Nemo", artist: "Thomas Newman" },
    { title: "Digga Tunnah", artist: "Le Roi Lion 3" },
    { title: "Cruella d'enfer", artist: "Les 101 Dalmatiens" },
    { title: "Rien ne vaut un ami", artist: "Rox et Rouky" },
    { title: "L'ombre et la lumière", artist: "Notre-Dame de Paris" }
  ],
  Pop: [
